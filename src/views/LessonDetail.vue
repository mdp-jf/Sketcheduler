...
<template>
  <div class="lesson-detail">
    <!-- Loading state -->
    <div v-if="loading || lessonsStore.loading || exercisesStore.loading" class="flex justify-center p-8">
    ...
    <div v-else>
      ...
      <div class="bg-white rounded-lg shadow p-6 mb-6">
        ...
        <AddExercise 
          ...
          :lessonId="Number(lessonsStore.currentLesson.id)"
        ...
        <!-- Exercise List -->
        <div v-else>
          <div v-if="exercisesStore.exercises.length === 0" class="text-center py-8 bg-gray-50 rounded">
