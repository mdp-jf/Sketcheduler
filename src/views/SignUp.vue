<template>
    <div class="min-h-screen bg-gradient-to-br from-indigo-50 to-blue-100 py-12 px-4 sm:px-6 lg:px-8 flex flex-col justify-center">
      <div class="max-w-md w-full mx-auto">
        <!-- Logo/Brand -->
        <div class="text-center mb-8">
          <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-blue-600 text-white text-2xl font-bold mb-4">A</div>
          <h2 class="text-3xl font-extrabold text-gray-800">Create a new account</h2>
          <p class="mt-2 text-sm text-gray-600">
            Or
            <RouterLink class="font-medium text-blue-600 hover:text-blue-500"
                to="/sign-in"
            >
